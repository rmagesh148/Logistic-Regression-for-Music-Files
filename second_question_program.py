...
final_input=np.load('F:/top_20.npy')#please read the readme file, I have already used top_20.py to extract the top 20 features and used it here
class_matrix_final=np.load('F:/class_label.npy') #class labels matrix
